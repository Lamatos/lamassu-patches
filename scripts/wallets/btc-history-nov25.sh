...
OUT="/tmp/btc-funding-history-nov25.csv"
...
# Nov 2025 date range (UTC)
# Nov 1 2025 00:00:00 → 1761955200
# Nov 31 2025 23:59:59 → 1764547199
START=1761955200
END=1764547199

echo "address,amount,txid,time" > "$OUT"

echo "Exporting BTC funding history for November 2025..."
